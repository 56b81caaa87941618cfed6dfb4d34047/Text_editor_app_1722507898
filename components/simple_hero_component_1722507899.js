...
Vue.component("simple_hero_component_1722507899", {
    template: `
        <section id="hero-section" style="min-height: 670px" class="bg-gradient-to-r from-purple-600 via-pink-500 to-magenta-500 flex-1">
            <div id="hero-container" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                ...
                <div id="hero-image-container" class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                    <img id="hero-image" src="https://makeinfinite-mentat-test.azurewebsites.net/get_image/tmplyp5izay/hero.png" alt="hero image" class="rounded-xl shadow-lg">
                </div>
            </div>
        </section>            
    `,
